...
def main(cfg: FairseqConfig) -> None:
    ...
    while epoch_itr.next_epoch_idx <= max_epoch:
        if lr <= cfg.optimization.stop_min_lr:
            ...
            break
#         if metrics.BleuLog.minus_gram >= 10:
#             logger.info(
#                 f"stopping training because current minus_gram is smaller "
#                 "than or equal to 10 ")
#             break
        # train for one epoch
...
#         if stats['best_bleu'] > stats['bleu']:
#             metrics.BleuLog.minus_gram += 1
#             metrics.BleuLog.change_flag = True
#         print("\nNow Gram is N-",metrics.BleuLog.minus_gram,'\n')
