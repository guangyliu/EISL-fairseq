...
#     --max-epoch $max_epoch --no-epoch-checkpoints   --patience  3 --ngram $ngram #--eval-bleu-print-samples  --log-interval 5
# done
...
# sym="cetf"
# cuda=0
# loss=cross_entropy #"ngrambleuloss_nat" # cross_entropy
# model="bart_base" # "bart_base_iter"
# tf_ratio=1.0 #'1.0'
# noise="$base_noise$i"
# data="wmt18-raw-bin/wmt18_raw_raw_1m"
# max_epoch=1
# name=${loss:0:2}"_"${noise}"_"${model:0:2}"_"$tf_ratio"_"$sym
# TOTAL_NUM_UPDATES=10000  
# WARMUP_UPDATES=500      
...
# # BART_PATH=/home/lptang/fairseq/examples/bart/pretrained/bart.base/model.pt
# BART_PATH=/home/lptang/fairseq/checkpoints/denoising_bart_wmt/wmt18_0904/cr_ba_1.0_raw_1m/checkpoint_best.pt
# BATCH_SIZE=128
# if [ ! -d "log/out/"$preix ]; then
#   mkdir "log/out/"$preix
#   echo "crete folder log/out/"$preix
...
sym="cetf"
cuda=0
loss=ngrambleuloss_nat #"ngrambleuloss_nat" # cross_entropy
model="bart_base" # "bart_base_iter"
tf_ratio=1.0 #'1.0'
noise="$base_noise$i"
data="wmt18-raw-bin/wmt18_raw_raw_1m"
